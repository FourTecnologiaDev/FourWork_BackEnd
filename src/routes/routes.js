...
const cartaInformativa = require('./cartaInformativa')
...
router.route('/cartaInformativa').all(authenticateToken, cartaInformativa)
router.route('/pesquisarCartaInformativa').all(authenticateToken, cartaInformativa)
